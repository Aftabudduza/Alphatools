<%@ Page Title="Alpha Professional Tools® :: Become A Distributor" Language="C#" MasterPageFile="~/MasterPages/Home.master" AutoEventWireup="true" CodeFile="BecomeADistributor.aspx.cs" Async="true" Inherits="pages_BecomeADistributor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
   <div class="page-intro">
        <ol class="breadcrumb">
                ...
                <li class="active">Become A Distributor</li>
            </ol>
    </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title"> <h3>Become A Distributor</h3></span>
                        </div>
                        <div class="panel-body">
                             <asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
                    </asp:ToolkitScriptManager>
                            <p>To become an Authorized Alpha® Distributor, please complete the following form and an Alpha® representative will contact you. </p>
