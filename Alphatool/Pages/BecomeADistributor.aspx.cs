...
public partial class pages_BecomeADistributor : Page
{
    string PageTitle = "";
    string PageName = "";
    string errStr = "";
    ...
    public bool SendEmail()
    {
        ...
        try
        {
            ...
            //objMailMessage.Subject = "Request to Become A New Distributor from alpha-tools.com";
            ...
            //objSmtpClient = new System.Net.Mail.SmtpClient(strMailUser, Convert.ToInt32(strMailPort));
            //objSmtpClient.EnableSsl = true;
            //objSmtpClient.Credentials = new System.Net.NetworkCredential(strMailUser, strMailPassword);
    ...
    //        {
    //            Subject = "Request to Become A New Distributor from alpha-tools.com",
    ...
    //        ////SmtpClient client = new SmtpClient(); // Keep server name if it's other than local
    //        ////MailAddress from = new MailAddress(from_address); //Email from
    //        ////MailAddress to = new MailAddress(to_address); //Email To
    //        ////MailMessage message = new MailMessage(from, to);
           
    //        ////message.Subject = "Request from New Distributor on Alphatools";
    //        ////message.IsBodyHtml = true;
    //        ////message.Body = this.EmailHtml().ToString();
    ...
    //       // objMailMessage.To.Add(new System.Net.Mail.MailAddress(to_address));
    //       //// objMailMessage.CC.Add(new System.Net.Mail.MailAddress("info@alpha-tools.com"));
    //       // objMailMessage.Subject = "Request from New Distributor on Alphatools";
    //       // objMailMessage.IsBodyHtml = true;
    //       // objMailMessage.Body = this.EmailHtml().ToString();
    //       // objSmtpClient.Send(objMailMessage);
    //       // IsSentSuccessful = true;
